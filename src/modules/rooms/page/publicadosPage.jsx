...
export default function RoomsPage() {
  ...
  const handleSolicitarRenta = async (room) => {
    try {
      ...
      if (!user) {
        Swal.fire({
          ...
          text: "Inicia sesión para solicitar una renta",
      ...
      await rentService.create(rentaData);
      ...
      console.error("Error al solicitar renta:", error);
      ...
      {roomsFinal.length === 0 ? (
        ...
        <div className="row g-4">
          {roomsFinal.map((room) => {
            ...
            const isRequesting = requestingId === roomId;
                ...
                <div className="room-card h-100">
                  ...
                  <div className="room-card-body d-flex flex-column">
                    ...
                    <div className="room-buttons d-flex flex-wrap gap-2">
                      ...
                      >
                        {isRequesting ? "Enviando..." : "Solicitar renta"}
                      </button>
                    </div>
                  </div>
                </div>
